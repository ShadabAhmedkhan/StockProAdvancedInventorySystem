...
/** The fields common to self-registration and an admin-issued account: a name, an
 * email and a password. What differs between the two - creating a new organization
 * vs. joining the caller's - lives on the subclasses instead. */
