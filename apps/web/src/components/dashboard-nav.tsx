...
export const NAV_LINKS: NavLink[] = [
  ...
  { href: '/dashboard/product-units', label: 'Serial/IMEI', icon: ScanLine },
  ...
  { href: '/dashboard/stock-counts', label: 'Stock counts', icon: ClipboardCheck },
  { href: '/dashboard/reorder', label: 'Reorder', icon: RefreshCw, roles: ['ADMIN', 'MANAGER'] },
